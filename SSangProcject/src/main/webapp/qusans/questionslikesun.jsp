...
sql = "select * from Question where que_subject like ? order by que_chu desc";
try{	
...
<div class="community-body__content">
    ...
    <button class="ac-button is-md is-text" onclick="location.href='index.jsp?main=qusans/questionssol.jsp'">해결됨</button>
    </li></ul>
  ...
  <form class="search e-search" action="index.jsp?main=qusans/questionssearch.jsp" method="post">
    ...
    <div class="ac-input-with-item search-by-text e-search-input ">
      ...
      <input type="text"placeholder="궁금한 질문을 검색해보세요!" enterkeyhint="search" name="search">
