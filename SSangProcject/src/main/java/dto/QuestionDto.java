...
public class QuestionDto {
   ...
   public QuestionDto() {}
   public QuestionDto(int num , String id, String subject, String content,String img, Timestamp date, int chu, int sol) {
      this.que_num=num;
      this.que_id=id;
...
public int getQue_sol() {
	return que_sol;
}
public void setQue_sol(int que_sol) {
	this.que_sol = que_sol;
}
